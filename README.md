...
This project is a simple background remover tool that allows users to upload an image and automatically remove its background. The goal of the project is to make it easy to isolate subjects from images without needing advanced photo editing skills or professional software. The tool processes an image, detects the main subject, and removes the surrounding background, producing a clean result that can be downloaded
